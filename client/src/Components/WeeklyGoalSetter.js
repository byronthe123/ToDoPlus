...
class WeeklyGoalSetter extends Component {
    ...
    validateGoalTime = (setWeeklyProductivityGoal, updateGoalStatus) => {
        ...
        if(noGoalTime) {
            ...
            setWeeklyProductivityGoal(this.goalTimeToSeconds(hourDelta, minuteDelta));
        }
    ...
    render() {
        return(
            <Consumer>
                {({setWeeklyProductivityGoal, updateGoalStatus}) => (
                    <div>
                        ...
                        <div>
                            <Button className='btn-login' onClick={() => this.validateGoalTime(setWeeklyProductivityGoal, updateGoalStatus)}>Set Goal</Button>
                        </div>
                    </div>
                )}
            </Consumer>
